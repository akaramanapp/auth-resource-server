...
public class NoteServiceController {
	...
	public String createNote() {
		...
		accessTokenMapper = (AccessTokenMapper)
				((OAuth2AuthenticationDetails) _securityContextHolder.getContext().getAuthentication().getDetails()).getDecodedDetails();
		...
		System.out.println("Access Token ID:"+accessTokenMapper.getAccess_token());
